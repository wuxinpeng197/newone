...
import listingsData from './tempData/listingsData.js'
...
class App extends Component {
    ...
    filteredData() {
        ...
        if (this.state.rentingway!= "All") {
            newData = newData.filter((item) => {
                return item.rentingway == this.state.rentingway
            })
        }
        if (this.state.suburb != "All") {
            newData = newData.filter((item) => {
                return item.suburb == this.state.suburb
            })
        }
        ...
        if (this.state.gender) {
            newData = newData.filter((item) => {
                return item.extras.includes('gender') == this.state.gender
            })
        }
    ...
    populateForms() {
        ...
        //sublet
        var rentingway = this.state.listingsData.map((item) => {
            return item.rentingway
        })
        rentingway = new Set(rentingway)
        rentingway = [...rentingway].sort()
        //suburb
        var suburb = this.state.listingsData.map((item) => {
            return item.suburb
        })
        suburb = new Set(suburb)
        suburb = [...suburb].sort()
